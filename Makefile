...
# OPNsense 26.7 sets PYTHON via dns_unbound_SET. This fork also enables
# DNSTAP (official package ships with DNSTAP=off).
OPTIONS_DEFAULT=	DNSCRYPT DNSTAP DYNLIB ECDSA EVAPI GOST LIBEVENT PYTHON THREADS
OPTIONS_SUB=		yes
